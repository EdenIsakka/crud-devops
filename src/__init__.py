...
from controller.controller_doctor import create_doctor, read_doctors, update_doctor, patch_doctor, delete_doctor
...
app.add_url_rule('/read-medicos', 'read_medicos', read_doctors, methods=['GET'])
